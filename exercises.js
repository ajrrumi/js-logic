...
var showResult = isGreaterThan(15, 14);
console.log("Is Greater Than: ", showResult);
/*
 * #4
 * Function - mustBeTrue
...
console.log("Must Be True: ", mustBeTrue(false));
...
console.log("Big Bird: ", bigBird("dog"));
...
console.log("Not Equal: ", notEqual("yang", "yang"));
...
console.log("Spare Change: ", spareChange(101));
...
console.log("Dirty 30: ", dirty30(29, 1, 1));
...
console.log("Even Stevens: ", evenStevens(2));
...
console.log("Da Club: ", daClub(21, 21));
/*
 * #12
 * Function - graduation
...
var gradResults = graduation(119, false);
